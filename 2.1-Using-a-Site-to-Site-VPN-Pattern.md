...
4. For active-active configurations in support of high-availability and disaster recovery scenarios see [Configure active-active S2S VPN connections with Azure VPN Gateways] (https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-activeactive-rm-powershell)
  
5. Configure the on-premises VPN device to establish the S2S VPN tunnel with the Azure VPN gateway
